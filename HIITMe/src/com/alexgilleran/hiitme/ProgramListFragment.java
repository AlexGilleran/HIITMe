...
/**
 * A list fragment representing a list of Programs. This fragment
 * also supports tablet devices by allowing list items to be given an
 * 'activated' state upon selection. This helps indicate which item is
 * currently being viewed in a {@link ProgramDetailFragment}.
 * <p>
...
public class ProgramListFragment extends ListFragment {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setListAdapter(new ArrayAdapter<Program>(
                getActivity(),
